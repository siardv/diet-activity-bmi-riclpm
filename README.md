...
Research compendium for **Socioeconomic Variations in the Reciprocal Relationships Between Diet Quality, Physical Activity, and Body Mass Index: A Random-Intercept Cross-Lagged Panel Study** (target journal: *Social Science & Medicine*). The compendium grew out of the working project "reciprocal health dynamics"; the package name (`reciprocal.health.dynamics`) and site title retain that name, while the repository slug matches the article's constructs.
